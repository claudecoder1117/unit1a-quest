...
//
// Stems are verbatim from content/SOURCE.md §4/§5 (the content authority). The 51 qz-*/bonus-* stems were
// diffed against the Quizlet export (source/quizlet.txt, 2026-09-17) and now carry the Quizlet wording; the only
// departures are the §0 notation markup ({ray AB}, {seg AB}, {ang ABC}, rendered by js/mathfmt.js) where the
// Quizlet used italic letters / arrows, and two typo fixes (bonus-03 "the the", bonus-16 "than that one of").
//
...
const ASN = [
  ...
  [5, 'A', 'A line can be drawn through 2 points.',
    ['This is a postulate about points and lines.', 'Through any two points there is exactly one ___.', 'The postulate guarantees that line for every pair of points — is there any pair it skips?'],
  ...
  [27, 'N', 'Two planes that are parallel contain the same point.',
    ['What does parallel mean for planes?', 'Parallel planes have no intersection.', 'No intersection means no shared point at all.'],
...
const BONUS = [
  ...
  [4, 'A', '2 triangles are congruent if 2 sides and the included angle of 1 are congruent to 2 sides and the included angle of the other.',
  ...
  [10, 'S', 'If {ang BAC} ≅ {ang ABC} in △ABC, then {seg AB} ≅ {seg BC}.',
  ...
  [11, 'S', '2 triangles are congruent if 2 sides and an angle of one are congruent to corresponding parts of another.',
  ...
  [12, 'A', 'If 2 sides of a right triangle are congruent to the corresponding parts of another right triangle the triangles are congruent.',
  ...
  [15, 'S', 'An exterior angle of a triangle is larger in measure than any angle of a triangle.',
  ...
  [16, 'N', 'One of the base angles of an isosceles triangle has a measure greater than one of the exterior angles of the triangle.',
  ...
  [19, 'S', 'A line in the plane of the ceiling and a line in the plane of the floor are parallel.',
  ...
  [23, 'A', 'Two lines parallel to a third line are parallel to each other.',
  ...
  [24, 'S', 'Two planes parallel to the same line are parallel to each other.',
  ...
  [26, 'A', 'Two planes parallel to the same plane are parallel to each other.',
  ...
  [27, 'S', 'Two lines perpendicular to a third line are parallel to each other.',
  ...
  [30, 'S', 'If a line intersects one of two parallel lines, then it intersects the other line also.',
  ...
  [31, 'S', 'If the sides of two angles lie in parallel lines, then the angles are congruent.',
  ...
  [32, 'A', 'If line t is skew to line m, there exists a plane that contains line t and is parallel to line m.',
  ...
  [33, 'A', 'If line m is skew to line k, there exists a line that is perpendicular to both m and k.',
...
export const qzCards = QZ.map(([n, answer, stem, hints, say, math]) => {
  ...
  return mk({
    ...
    reason: bank.reason, distractors: bank.distractors,
    disputed: n === 4 ? 'Quizlet says S — and S is right (a line and a ray can be skew); an earlier draft flagged it as A' : undefined,
  });
});
