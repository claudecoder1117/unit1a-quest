...
/* ------------------------------------------------------------------ the prediction
   ...
   DEMOLITION (notes/DEMOLISH.md): the Mock's prediction used to be entered in the game's 50-call
   RATING window as one weighed call — the ladder, its weight law, its eligibility gate and the rank
   it bought. designs/CUT-BRIEF.md deletes the rating, the rank and the Elo pair, so the write goes
   with them. The prediction itself is the study layer's and is untouched: the student still calls
   their score before the paper and still reads `calibration()` after it.                          */
