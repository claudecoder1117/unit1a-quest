...
/* ------------------------------------------------------------------ the game
   ...
   DEMOLITION (notes/DEMOLISH.md): the Ledger panel (rating, rank, Elo, the eight records), the crew
   grid, the 68-entry Fault Index and the Reliability scorecard are gone with the mechanics they
   measured (designs/CUT-BRIEF.md). The game keeps two numbers — today's points and the best day —
   and it prints them where they are earned, at the end of a session, not on a panel here.          */
